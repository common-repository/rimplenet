...
function nav_menu_update( $menu_id, $menu_item_db_id ) {
 ...
 public function DesignDashboard($atts) {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style('material-kit-css', plugin_dir_url( __FILE__ ) . 'css/material-kit.css', array(), $this->version, 'all' );
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/rimplenet-mlm-public.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script($this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/rimplenet-mlm-public.js', array( 'jquery' ), $this->version, true );
