...
class Rimplenet_Mlm {
	...
	public function __construct() {
		if ( defined( 'BNVB_MLM_VERSION' ) ) {
			$this->version = BNVB_MLM_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->plugin_name = 'rimplenet-mlm';
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		 require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/tgmpa/class-tgm-plugin-activation.php';
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-rimplenet-mlm-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-rimplenet-mlm-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-rimplenet-mlm-admin.php';

		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-rimplenet-mlm-public.php';

		$this->loader = new Rimplenet_Mlm_Loader();
	...
	private function set_locale() {
		...
		$plugin_i18n = new Rimplenet_Mlm_i18n();
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Rimplenet_Mlm_Admin( $this->get_plugin_name(), $this->get_version() );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Rimplenet_Mlm_Public( $this->get_plugin_name(), $this->get_version() );
