         ...
         <?php
            ...
            elseif($_GET["tab"] == "create-credit-tab")
             ...
             { 
               ...
               $path_to_tab = plugin_dir_path( dirname( __FILE__ ) ) . "layouts/get-debits.php";
             }
             
             //Set the url for each of the tab
             $overview_tab_url = add_query_arg( array( 'post_type'=>$_GET["post_type"], 'page'=>$_GET["page"], 'tab'=>'debits-overview', 'viewing_user'=>$current_user->ID), admin_url( "edit.php") );
             $setup_tab_url = add_query_arg( array( 'post_type'=>$_GET["post_type"], 'page'=>$_GET["page"], 'tab'=>'create-debit-tab', 'viewing_user'=>$current_user->ID), admin_url( "edit.php") );
